 ...
 * Lớp :CCQ2311D
 * Ngày tạo: 06-06-2026
 * Mô tả : Thực thể CategoryProductList là một Component React chịu trách nhiệm hiển thị danh sách các danh mục sản phẩm. Nó sử dụng categoryProductService để gọi API lấy dữ liệu và quản lý trạng thái hiển thị thông qua useState và useEffect.
 */
